...
/**
 * new_dog - This is the bnew dog to be created
 ...
 *
 * Description: This function creates a new dog structure by allocating memory
 *              for the structure and copies of the name and owner strings.
 *              It assigns the provided age to the newdog and returns a pointer
 *		to the newly created dog structure. If the
